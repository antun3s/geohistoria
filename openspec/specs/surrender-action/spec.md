# surrender-action Specification

## Purpose

Oferecer uma saída honesta ao jogador que esgotou os pulos e não sabe a resposta: o botão de pular morfa para "Não sei" e a desistência encerra a partida imediatamente, sem custo de vida, com revelação da personalidade e contabilização própria no resumo final.
